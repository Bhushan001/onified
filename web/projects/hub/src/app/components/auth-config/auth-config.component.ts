  ...
  template: `
    <div class="auth-config-container">
      <div class="auth-config-card">
        <div class="header">
          <h1>Hub Configuration Required</h1>
        ...
        <div class="content">
            ...
            <form [formGroup]="loginForm" (ngSubmit)="onSubmit()">
              ...
              <div class="form-group">
                ...
                <input 
                  ...
                  class="form-control"
                >
                <small>Leave empty to use default API URL</small>
              </div>
          ...
          <div class="actions">
            <button class="btn-secondary" (click)="refreshAuth()">
              Refresh Authentication
            </button>
            <button class="btn-secondary" (click)="clearAuth()">
...
export class AuthConfigComponent {
  ...
  onSubmit(): void {
    if (this.loginForm.valid) {
      ...
      const apiUrl = this.loginForm.get('apiUrl')?.value;
      if (apiUrl) {
        // You might want to update the environment or service configuration
        console.log('API URL would be updated to:', apiUrl);
      }
